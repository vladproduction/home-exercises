package constructor.constructor_from_constructor;
...
//!    this(11); // Не внутри - не конструктор!
    ...
    говорите this.s, чтобы указать на член-данное. Вы часто будите видеть эту форму использования в Java коде,
